...
const file_meshtastic_config_proto_rawDesc = "" +
	...
	"meshtastic\x1a\x1ameshtastic/device_ui.proto\"\x8b7\n" +
	"\x06Config\x129\n" +
	...
	"\x14DEGREES_270_INVERTED\x10\a\x1a\xa3\f\n" +
	"\n" +
	"LoRaConfig\x12\x1d\n" +
	"\n" +
	...
	"femLnaMode\x12&\n" +
	"\x0fserial_hal_only\x18k \x01(\bR\rserialHalOnly\"\xfb\x02\n" +
	"\n" +
	"RegionCode\x12\t\n" +
	...
	"\aITU1_2M\x10\x1b\x12\f\n" +
	"\bITU23_2M\x10\x1c\x12\n" +
	"\n" +
